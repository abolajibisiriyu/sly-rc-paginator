  ...
  _createClass(Paginator, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          ...
          totalItems = _props$meta.totalItems,
          currentPage = _props$meta.currentPage,
          itemsPerPage = _props$meta.itemsPerPage;


      !_lodash2.default.isEmpty(meta) && this.setState({
    ...
    value: function componentDidUpdate(prevProps) {
      var _props2 = this.props,
          ...
          totalItems = _props2$meta.totalItems,
          currentPage = _props2$meta.currentPage,
          itemsPerPage = _props2$meta.itemsPerPage;


      if (!_lodash2.default.isEqual(meta, prevProps.meta)) {
        !_lodash2.default.isEmpty(meta) && this.setState({
          pager: this.getPager(totalItems, currentPage, itemsPerPage)
        });
      }
    ...
    key: "getPager",
    value: function getPager(_totalItems, _currentPage, _itemsPerPage) {
      ...
      var numberOfPages = Math.ceil(_totalItems / itemsPerPage);
    ...
    value: function render() {
      ...
      return !_lodash2.default.isEmpty(pager) && _react2.default.createElement(
        "ul",
        { className: options.ulClassName },
        ...
        pager.pages && pager.pages.map(function (page, index) {
          return _react2.default.createElement(
            ...
            {
              key: index,
              className: pager.currentPage === page ? options.activeClassName : ""
            },
            _react2.default.createElement(
              "a",
              {
        ...
        _react2.default.createElement(
          "li",
          {
            className: pager.currentPage === pager.numberOfPages ? options.disabledClassName : ""
          },
          _react2.default.createElement(
            "a",
            {
